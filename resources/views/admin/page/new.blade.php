...
@section('content')
    ...
    <form action="{{ route('page.store') }}@yield('edtID')" method="post">
                ...
                <textarea class="textarea" id="content" name="content" placeholder="Post Content">
                    ...
                    <div class="field is-horizontal">
                        ...
                        <div class="field-body">
                            <div class="field">
                                <div class="control">
                                    <textarea class="textarea" id="excerpt" name="excerpt"
                                              placeholder="excerpt">@yield('edtExcerpt')</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box">
                   ...
                   <span class="input-group-btn">
                     <a id="lfm" data-input="thumbnail" data-preview="holder" class="btn btn-primary btn-sm">
                       ...
                       <a id="killFeature" data-input="thumbnail" data-preview="holder" class="btn btn-danger btn-sm">
                       <i class="fa fa-picture-o"></i> Remove
                     </a>
                   </span>
                        <input id="thumbnail" class="form-control" type="hidden" name="meta[posts_featured_image][]"
                               value="@yield('edtFimg')">
