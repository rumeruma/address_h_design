                        ...
                        <div class="list-group">
                            ...
                            @if(count($category->childs))
                                ...
                                @foreach($category->childs as $child)
                                    <a id="{{ $child->name }}" href="{{ route('show.buscat', [$child->name]) }}" class="list-group-item">
                ...
                <div class="col-md-9 col-sm-8 col-xs-12">
                    ...
                    <div class="row">
                        ...
                        @foreach($posts as $pot)
                            ...
                            @php
                                $contactmeta = posts_meta(get_metaext($pot->posts->meta), 'contacts');
                                ...
                                $image = posts_meta(get_metaext($pot->posts->meta), 'posts_featured_image');
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="feature-item-container-box listing-item">
                                    ...
                                    <div style="min-height: 15rem; max-height: 15.1rem;" class="feature-box-text">
                                        <h3>
                                            <a href="{{ route('home.post',[$pot->posts->name]) }}">{{ $pot->posts->title }}</a>
                                        </h3>
                                        <a href="#"><i class="fa fa-phone"></i>{{ $contact }}</a>
                                        <p>{{ (cut_limit($pot->posts->excerpt, 12)) ? cut_limit($pot->posts->excerpt, 12) : "There are many variations of passages of Lorem Ipsum available, but the majority" }}</p>
                                    </div>
